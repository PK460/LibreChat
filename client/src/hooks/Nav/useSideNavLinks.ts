...
import RequirementAnalysisPanel from '~/components/SidePanel/RequirementAnalysis/Panel';
...
export default function useSideNavLinks({
  ...
  const Links = useMemo(() => {
    ...
    links.push({
      title: 'com_ui_requirement_analysis',
      label: '',
      icon: ClipboardList,
      id: 'requirement-analysis',
      Component: RequirementAnalysisPanel,
    });
    ...
    links.push({
      title: 'com_nav_tool_remove',
      label: 'com_nav_tool_remove',
      icon: AttachmentIcon,
      id: 'files',
